...
TOP=~/android/cm10-mbm; export TOP
#
...
git apply $TOP/patches/patches/development.patch
cd $TOP
#
# echo "device_hp_tenderloin patches"
# cd device/hp/tenderloin
# Change to portrait mode.
# git apply $TOP/patches/patches/device_hp_tenderloin_portrait.patch
# cd $TOP
#
...
git apply $TOP/patches/patches/external_wpa_supplicant_8.patch
cd $TOP
#
...
git apply $TOP/patches/patches/system_netd.patch
cd $TOP
#
